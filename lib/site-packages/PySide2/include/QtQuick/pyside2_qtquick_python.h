...
// Type indices
enum : int {
    SBK_QQUICKASYNCIMAGEPROVIDER_IDX                         = 11,
    SBK_QQUICKFRAMEBUFFEROBJECT_IDX                          = 12,
    SBK_QQUICKFRAMEBUFFEROBJECT_RENDERER_IDX                 = 13,
    SBK_QQUICKIMAGEPROVIDER_IDX                              = 14,
    SBK_QQUICKIMAGERESPONSE_IDX                              = 15,
    SBK_QQUICKITEM_FLAG_IDX                                  = 17,
    SBK_QFLAGS_QQUICKITEM_FLAG_IDX                           = 0,
    SBK_QQUICKITEM_ITEMCHANGE_IDX                            = 18,
    SBK_QQUICKITEM_TRANSFORMORIGIN_IDX                       = 19,
    SBK_QQUICKITEM_IDX                                       = 16,
    SBK_QQUICKITEM_UPDATEPAINTNODEDATA_IDX                   = 20,
    SBK_QQUICKITEMGRABRESULT_IDX                             = 21,
    SBK_QQUICKPAINTEDITEM_RENDERTARGET_IDX                   = 24,
    SBK_QQUICKPAINTEDITEM_PERFORMANCEHINT_IDX                = 23,
    SBK_QFLAGS_QQUICKPAINTEDITEM_PERFORMANCEHINT_IDX         = 1,
    SBK_QQUICKPAINTEDITEM_IDX                                = 22,
    SBK_QQUICKRENDERCONTROL_IDX                              = 25,
    SBK_QQUICKTEXTDOCUMENT_IDX                               = 26,
    SBK_QQUICKTEXTUREFACTORY_IDX                             = 27,
    SBK_QQUICKTRANSFORM_IDX                                  = 28,
    SBK_QQUICKVIEW_RESIZEMODE_IDX                            = 30,
    SBK_QQUICKVIEW_STATUS_IDX                                = 31,
    SBK_QQUICKVIEW_IDX                                       = 29,
    SBK_QQUICKWINDOW_CREATETEXTUREOPTION_IDX                 = 33,
    SBK_QFLAGS_QQUICKWINDOW_CREATETEXTUREOPTION_IDX          = 2,
    SBK_QQUICKWINDOW_RENDERSTAGE_IDX                         = 35,
    SBK_QQUICKWINDOW_SCENEGRAPHERROR_IDX                     = 36,
    SBK_QQUICKWINDOW_TEXTRENDERTYPE_IDX                      = 37,
    SBK_QQUICKWINDOW_NATIVEOBJECTTYPE_IDX                    = 34,
    SBK_QQUICKWINDOW_IDX                                     = 32,
    SBK_QSGABSTRACTRENDERER_CLEARMODEBIT_IDX                 = 39,
    SBK_QFLAGS_QSGABSTRACTRENDERER_CLEARMODEBIT_IDX          = 3,
    SBK_QSGABSTRACTRENDERER_MATRIXTRANSFORMFLAG_IDX          = 40,
    SBK_QFLAGS_QSGABSTRACTRENDERER_MATRIXTRANSFORMFLAG_IDX   = 4,
    SBK_QSGABSTRACTRENDERER_IDX                              = 38,
    SBK_QSGBASICGEOMETRYNODE_IDX                             = 41,
    SBK_QSGCLIPNODE_IDX                                      = 42,
    SBK_QSGDYNAMICTEXTURE_IDX                                = 43,
    SBK_QSGENGINE_CREATETEXTUREOPTION_IDX                    = 45,
    SBK_QFLAGS_QSGENGINE_CREATETEXTUREOPTION_IDX             = 5,
    SBK_QSGENGINE_IDX                                        = 44,
    ...
    SBK_QSGMATERIALTYPE_IDX                                  = 57,
    SBK_QSGNODE_NODETYPE_IDX                                 = 61,
    SBK_QSGNODE_FLAG_IDX                                     = 60,
    SBK_QFLAGS_QSGNODE_FLAG_IDX                              = 7,
    SBK_QSGNODE_DIRTYSTATEBIT_IDX                            = 59,
    SBK_QFLAGS_QSGNODE_DIRTYSTATEBIT_IDX                     = 6,
    SBK_QSGNODE_IDX                                          = 58,
    SBK_QSGOPACITYNODE_IDX                                   = 62,
    SBK_QSGRENDERERINTERFACE_GRAPHICSAPI_IDX                 = 64,
    SBK_QSGRENDERERINTERFACE_RESOURCE_IDX                    = 65,
    SBK_QSGRENDERERINTERFACE_SHADERTYPE_IDX                  = 68,
    SBK_QSGRENDERERINTERFACE_SHADERCOMPILATIONTYPE_IDX       = 66,
    SBK_QFLAGS_QSGRENDERERINTERFACE_SHADERCOMPILATIONTYPE_IDX = 8,
    SBK_QSGRENDERERINTERFACE_SHADERSOURCETYPE_IDX            = 67,
    SBK_QFLAGS_QSGRENDERERINTERFACE_SHADERSOURCETYPE_IDX     = 9,
    SBK_QSGRENDERERINTERFACE_IDX                             = 63,
    SBK_QSGSIMPLERECTNODE_IDX                                = 69,
    SBK_QSGSIMPLETEXTURENODE_TEXTURECOORDINATESTRANSFORMFLAG_IDX = 71,
    SBK_QFLAGS_QSGSIMPLETEXTURENODE_TEXTURECOORDINATESTRANSFORMFLAG_IDX = 10,
    SBK_QSGSIMPLETEXTURENODE_IDX                             = 70,
    SBK_QSGTEXTURE_WRAPMODE_IDX                              = 75,
    SBK_QSGTEXTURE_FILTERING_IDX                             = 74,
    SBK_QSGTEXTURE_ANISOTROPYLEVEL_IDX                       = 73,
    SBK_QSGTEXTURE_IDX                                       = 72,
    SBK_QSGTEXTUREPROVIDER_IDX                               = 76,
    SBK_QSGTRANSFORMNODE_IDX                                 = 77,
    SBK_QSHAREDPOINTER_QQUICKITEMGRABRESULT_IDX              = 79, // QSharedPointer<QQuickItemGrabResult >
    SBK_QSHAREDPOINTER_CONSTQQUICKITEMGRABRESULT_IDX         = 79, //   (const)
    SBK_QtQuick_IDX_COUNT                                    = 80
};
...
template<> inline PyTypeObject *SbkType< ::QSGRendererInterface::GraphicsApi >() { return SbkPySide2_QtQuickTypes[SBK_QSGRENDERERINTERFACE_GRAPHICSAPI_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGRendererInterface::Resource >() { return SbkPySide2_QtQuickTypes[SBK_QSGRENDERERINTERFACE_RESOURCE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGRendererInterface::ShaderType >() { return SbkPySide2_QtQuickTypes[SBK_QSGRENDERERINTERFACE_SHADERTYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGRendererInterface::ShaderCompilationType >() { return SbkPySide2_QtQuickTypes[SBK_QSGRENDERERINTERFACE_SHADERCOMPILATIONTYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QFlags<QSGRendererInterface::ShaderCompilationType> >() { return SbkPySide2_QtQuickTypes[SBK_QFLAGS_QSGRENDERERINTERFACE_SHADERCOMPILATIONTYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGRendererInterface::ShaderSourceType >() { return SbkPySide2_QtQuickTypes[SBK_QSGRENDERERINTERFACE_SHADERSOURCETYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QFlags<QSGRendererInterface::ShaderSourceType> >() { return SbkPySide2_QtQuickTypes[SBK_QFLAGS_QSGRENDERERINTERFACE_SHADERSOURCETYPE_IDX]; }
template<> inline PyTypeObject *SbkType< ::QSGRendererInterface >() { return reinterpret_cast<PyTypeObject *>(SbkPySide2_QtQuickTypes[SBK_QSGRENDERERINTERFACE_IDX]); }
